      ...
      <div className="HowCanHelpFund__wrapper">
        <div className="HowCanHelpFund__container">
          <div className="HowCanHelpFund__content">
            ...
            <div className="HowCanHelpFund__video-wrapper">
              <video 
                src={VideoDogAndWomen} 
                className="HowCanHelpFund__video"
                autoPlay 
                loop 
                muted 
                playsInline 
            ...
            <div className="HowCanHelpFund__body-content">
              <div className="HowCanHelpFund__body-wrapper">
                <div className="HowCanHelpFund__content">
                  
                  <div className="HowCanHelpFund__header">
                    <div className="HowCanHelpFund__header-text">
                      Чем я могу <br /> помочь?
                    </div>
                  </div>

                  <div className="HowCanHelpFund__body">
                    <div className="HowCanHelpFund__body-descr">
                      Любая помощь <br /> очень важна для нас:
                    </div>
                  </div>

                  <div className="HowCanHelpFund__footer">
                    
                    <Link 
                      className="HowCanHelpFund__card-item card-transform"
                      to='/animals'
                    >
                      <div className="HowCanHelpFund__card-header">Забрать домой</div>
                    ...
                    <Link 
                      ...
                      to='animals'
                    >
                      <div className="HowCanHelpFund__card-header">Помочь питомцу</div>
                      <div className="HowCanHelpFund__card-footer">
                        <ArrowRightCircleIcon className='icon' />
                      </div>
                    </Link>

                    <div className="HowCanHelpFund__card-item">
                      <div className="HowCanHelpFund__card-header">Рассказать про наш фонд друзьям</div>
                      <div className="HowCanHelpFund__icons-group">
                    ...
                    <div className="HowCanHelpFund__card-item">
                      <div className="HowCanHelpFund__card-header">Подарить сертификат</div>
                      <div className="HowCanHelpFund__card-footer card-footer-ozon">
